...
# ./exemplar_prototype/lvis/mmovod_maxIns100.pth
...
python ./train_net.py \
    ...
    MODEL.WEIGHTS models/CoDet_OVLVIS_R5021k_4x_ft4x.pth \
    MODEL.ROI_BOX_HEAD.PROTOTYPE_WEIGHT_PATH './exemplar_prototype/lvis/lvis_base_general.pth' \
