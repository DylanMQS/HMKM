...
python ./prototypes_generator_lvis_mp.py \
    ...
    --output exemplar_prototype/lvis/mmovod_maxInstancesnums100_.pth \
    --save-features 'lvis' \
    --save-perembeddings-path "exemplar_prototype/lvis/mmovod_maxInstancesnums100_context0.4_squareFalse/swin_embeddings/" \
    --opts MODEL.WEIGHTS models/CoDet_OVLVIS_SwinB_4x_ft4x.pth
