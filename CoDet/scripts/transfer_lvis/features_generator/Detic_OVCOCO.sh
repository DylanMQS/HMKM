...
python ./prototypes_generator_coco_mp.py \
    ...
    --vocabulary coco \
    --input  "../CKDet/exemplar_prototype/lvis/mmovod_maxInstancesnums10/regions/*/*" \
    --output ./exemplar_prototype/transfer_lvis/transfer_lvis_ins10_.pth \
    --save-features 'coco' \
    --save-perembeddings-path "./exemplar_prototype/transfer_lvis/transfer_lvis_ins10_/embeddings/" \
